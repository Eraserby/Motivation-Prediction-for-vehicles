...
# sys.path.append("D:/Eraser_python/pre_trajectory_for_vehicles/Eraser_model/data")

# from prediction_data import get_dataset # 从文件夹中获取prediction_data.py文件，并且获得数据函数
import os
...
plt.title('single MLP Training Loss vs. Epoch')
plt.subplot( 1 , 2, 2 )
